...
import com.hanjo.portfolio.admin.exception.AdminInternalServerErrorException
import com.hanjo.portfolio.domain.entity.ProjectSkill
import com.hanjo.portfolio.domain.repository.ProjectRepository
import com.hanjo.portfolio.domain.repository.ProjectSkillRepository
...
class AdminProjectSkillService(
    ...
    fun getProjectSkillTable(): TableDTO{
        ...
        val columns = mutableListOf<String>(
            "id", "projectId", "skillId", "skillName",
    ...
    fun save(form: ProjectSkillForm) {
        ...
        val project = projectRepository.findById(projectId)
            .orElseThrow{ throw AdminBadRequestException("ID ${projectId}의 해당하는 데이터를 찾을 수 없습니다.")}
        val skill = skillRepository.findById(projectId)
            .orElseThrow{ throw AdminBadRequestException("ID ${skillId}의 해당하는 데이터를 찾을 수 없습니다.")}
